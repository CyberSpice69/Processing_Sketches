...
class Box {
  ...
  // Constructor
  Box(float x, float y, color _SpawnColour) {
    w = random(32,64);
    h = w;
    SpawnColour = _SpawnColour;
    
    //randColour = color(random(128,255), random(128,255), random(128,255));
  ...
  void makeBody(Vec2 center, float w_, float h_) {
    ...
    body.setLinearVelocity(new Vec2(random(-5, 5), random(60, 80)));
